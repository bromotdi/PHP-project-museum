  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="collection/new_collection.php" method="POST">
          <input type="hidden" class="prodid" name="_id" id="_id">
          <div class="form-group">
            <label for="nameCollection" class="col-form-label">Name collection</label>
            <input type="text" class="form-control" id="nameCollection" name="nameCollection"/>
          </div>
          <div class="form-group">
  ...
  <table id="example1" class="table table-bordered">
    ...
    <tbody>
      <?php
        ...
        $query="SELECT id_exhibit, id_collection, name, photo FROM collection";
        ...
        foreach ($result as $obj) {
          ...
          echo '
            <tr> 
              <td>'.$obj["id_exhibit"].'</td>
              <td>'.$obj["id_collection"].'</td>
              <td>'.$obj["name"].'</td>
              <td>'.$obj["photo"].'</td>
              <td>
                <button type="button" class="btn btn-primary btn-success btn-sm edit btn-flat" data-toggle="modal" data-target="#edit" data-_id="'.$obj['id_exhibit'].'" data-name_collection="'.$obj["id_collection"].'" data-description="'.$obj["name"].'" data-photo="'.$obj["photo"].'">Edit</button>
                <button class="btn btn-danger btn-sm delete btn-flat" data-toggle="modal" data-target="#delete" data-_id="'.$obj['id_exhibit'].'"><i class="fa fa-trash"></i> Delete</button>       
              </td>
            </tr>';
        }                   
      ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                  ...
                  <form class="form-horizontal" method="POST" action="delete_collection.php">
...
var nameCollection = button.data('name_collection')
var description = button.data('description') 
var photo = button.data('photo') 
var modal = $(this)
modal.find('#_id').val(id)
modal.find('#nameCollection').val(nameCollection)
