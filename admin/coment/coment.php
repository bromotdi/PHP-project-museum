            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="../collection/catalog.php" class="nav-item nav-link ">Колекція</a>
                        ...
                        <a href="coment.php" class="nav-item nav-link active">Коментарі</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="coment/new_comment.php" method="POST">
          ...
          <div class="form-group">
            <label for="coment" class="col-form-label">Comment</label>
  ...
  <table id="example1" class="table table-bordered">
    ...
    <tbody>
      <?php
        ...
        $query="SELECT id_user, name, email, coment FROM coments";
        ...
        foreach ($result as $obj) {
          ...
          echo '
            <tr> 
              ...
              <td>'.$obj["coment"].'</td>
              <td>
                <button type="button" class="btn btn-primary btn-success btn-sm edit btn-flat" data-toggle="modal" data-target="#edit" data-_id="'.$obj['id_user'].'" data-name="'.$obj["name"].'" data-email="'.$obj["email"].'" data-coment="'.$obj["coment"].'">Edit</button>
                ...
                <button type="button" class="btn btn-primary btn-success btn-sm edit btn-flat" data-toggle="modal" data-target="#answer" data-_id="'.$obj['id_user'].'" data-name="'.$obj["name"].'" data-email="'.$obj["email"].'" data-coment="'.$obj["coment"].'" data-answr="">Answer</button>
                </td>
            </tr>';
        }                   
      ?>
      ...
      <div class="modal fade" id="answer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Відповідь</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="answer.php" method="POST">
                ...
                <div class="form-group">
                  <label for="answr" class="col-form-label">Answer</label>
                  <input type="text" class="form-control" id="answr" name="answr"/>
                </div>                  
            </div>
            <div class="modal-footer">
              <button type="submit" name="answer" class="btn btn-primary">Відповісти</button>
            </div>
            </form>
          </div>
        </div>
...
var email = button.data('email') 
var coment = button.data('coment') 
var answr = button.data('answr') 
var modal = $(this)
modal.find('#_id').val(id)
modal.find('#nameUser').val(nameUser)
modal.find('#email').val(email)
modal.find('#coment').val(coment)
modal.find('#answr').val(answr)
})
